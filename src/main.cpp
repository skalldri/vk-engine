...
void createSyncObjects() {
    ...
    // Initially, no one is using any swapchain images, so we initialize them to a NULL handle
    ...
    fenceInfo.flags = VK_FENCE_CREATE_SIGNALED_BIT; // Create fence in the "signaled" state so we don't stall
...
void drawFrame()
{
    ...
    // vkQueueSubmit will raise inFlightFences[currentFrame] when this set of commands has finished rendering
