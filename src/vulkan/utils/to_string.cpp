...
std::vector<std::string> vkSurfaceTransformFlagsToString(VkSurfaceTransformFlagsKHR flags) {
    ...
    if (flags & VK_SURFACE_TRANSFORM_IDENTITY_BIT_KHR) {
        flags_string.push_back("VK_SURFACE_TRANSFORM_IDENTITY_BIT_KHR");
    }

    if (flags & VK_SURFACE_TRANSFORM_ROTATE_90_BIT_KHR) {
        flags_string.push_back("VK_SURFACE_TRANSFORM_ROTATE_90_BIT_KHR");
    }

    if (flags & VK_SURFACE_TRANSFORM_ROTATE_180_BIT_KHR) {
        flags_string.push_back("VK_SURFACE_TRANSFORM_ROTATE_180_BIT_KHR");
    }

    if (flags & VK_SURFACE_TRANSFORM_ROTATE_270_BIT_KHR) {
        flags_string.push_back("VK_SURFACE_TRANSFORM_ROTATE_270_BIT_KHR");
    }

    if (flags & VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_BIT_KHR) {
        flags_string.push_back("VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_BIT_KHR");
    }

    if (flags & VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_90_BIT_KHR) {
        flags_string.push_back("VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_90_BIT_KHR");
    }

    if (flags & VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_180_BIT_KHR) {
        flags_string.push_back("VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_180_BIT_KHR");
    }

    if (flags & VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_270_BIT_KHR) {
        flags_string.push_back("VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_270_BIT_KHR");
    }

    if (flags & VK_SURFACE_TRANSFORM_INHERIT_BIT_KHR) {
        flags_string.push_back("VK_SURFACE_TRANSFORM_INHERIT_BIT_KHR");
    }
